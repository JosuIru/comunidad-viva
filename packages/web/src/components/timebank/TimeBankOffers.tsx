...
export default function TimeBankOffers({ onSelectOffer }: TimeBankOffersProps) {
  const t = useTranslations('timebankOffers');
  ...
  if (!data?.offers || data.offers.length === 0) {
    return (
      <div className="bg-white rounded-lg shadow border border-gray-200 p-12 text-center">
        ...
        <p className="text-gray-600 mb-2">{t('noOffers')}</p>
    ...
    <div className="bg-white rounded-lg shadow border border-gray-200">
      <div className="p-6 border-b border-gray-200">
        ...
        <p className="text-sm text-gray-600 mt-1">
          {data.total} {data.total === 1 ? t('offerAvailable') : t('offersAvailable')}
        </p>
      </div>
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex flex-wrap items-center gap-3 text-xs text-gray-600">
                  <span className="flex items-center gap-1">
                    ...
                    {offer.estimatedHours}{t('hoursEstimated')}
                  </span>
                  ...
                  >
                    {experienceLabels[offer.experienceLevel] || offer.experienceLevel}
                  </span>
