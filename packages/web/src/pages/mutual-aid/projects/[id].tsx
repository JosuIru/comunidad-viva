            ...
            <div className="bg-white rounded-lg shadow-sm p-8 mb-6">
              ...
              {project.vision && (
                <div className="bg-blue-50 border-l-4 border-blue-600 p-4 mb-6">
                  <h3 className="font-semibold text-blue-900 mb-2">Visión</h3>
                  <p className="text-blue-800">{project.vision}</p>
                </div>
              )}
              ...
              {project.targetEur && (
                <div className="mb-6">
                  <div className="flex justify-between text-sm mb-2">
                    ...
                    <span className="text-gray-600">{project.currentEur}€ de {project.targetEur}€</span>
                  </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                {project.beneficiaries && (
                  <div className="bg-gray-50 rounded-lg p-4">
                    <div className="text-sm text-gray-600 mb-1">Beneficiarios</div>
                    <div className="text-2xl font-bold text-gray-900">{project.beneficiaries}</div>
                  </div>
                )}
                {project.contributorsCount > 0 && (
                  <div className="bg-gray-50 rounded-lg p-4">
                    <div className="text-sm text-gray-600 mb-1">Contribuciones</div>
                    <div className="text-2xl font-bold text-gray-900">{project.contributorsCount}</div>
                  </div>
                )}
                {project.volunteersNeeded && (
                  <div className="bg-gray-50 rounded-lg p-4">
                    <div className="text-sm text-gray-600 mb-1">Voluntarios</div>
                ...
                {project.estimatedMonths && (
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <div className="text-2xl font-bold text-gray-900">{project.estimatedMonths}m</div>
                  </div>
                )}
              </div>
              ...
              {project.impactGoals && project.impactGoals.length > 0 && (
                <div className="mb-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-3">Objetivos de Impacto</h3>
              ...
              {project.sdgGoals && project.sdgGoals.length > 0 && (
                <div className="mb-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-3">ODS</h3>
      ...
      {showContributeModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg max-w-md w-full p-6">
            <h3 className="text-xl font-bold text-gray-900 mb-4">Contribuir al Proyecto</h3>
