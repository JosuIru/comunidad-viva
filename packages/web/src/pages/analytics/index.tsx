      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            M�tricas e insights de la comunidad
          </p>
        </div>
        ...
        {metricsLoading ? (
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                  Retenci�n: {metrics.retentionRate.toFixed(0)}%
                </p>
              </div>
            </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg p-4">
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400">
                    {metrics.growthRate > 10
                      ? 'La comunidad est� creciendo r�pidamente. Considera expandir recursos.'
                      : 'Crecimiento estable. Enf�cate en retenci�n y engagement.'}
                  </p>
                </div>
                <div className="bg-white dark:bg-gray-800 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 dark:text-white text-sm mb-2">
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400">
                    {metrics.averageCreditsPerUser > 100
                      ? 'Alta circulaci�n de cr�ditos. La econom�a es saludable.'
                      : 'Considera incentivar m�s transacciones para mejorar la econom�a.'}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="text-center py-16 bg-white dark:bg-gray-800 rounded-lg shadow-md">
            ...
            <p className="mt-2 text-gray-600 dark:text-gray-400">
              Selecciona un rango de fechas para ver las m�tricas
            </p>
          </div>
        )}
      </div>
