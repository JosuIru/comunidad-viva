...
Sistema completo de bridges que permite transferir tokens SEMILLA entre la blockchain interna de Truk y blockchains externas de bajo costo (Polygon y Solana).
...
Desarrollado para Truk como parte del ecosistema Gailu Labs.
