...
El sistema de bridges permite a los usuarios transferir tokens SEMILLA entre la blockchain interna de Truk y blockchains externas como Polygon y Solana.
...
## Flujo de Uso: LOCK (Truk → External Chain)
...
## Flujo de Uso: UNLOCK (External Chain → Truk)
...
### Paso 2: Solicitar Unlock en Truk
